---
title: TileOverlay
description: Display custom map tile layers on top of the base map.
---
...
|----------|------|-------------|
| `northeast` | [`Coordinate`](../types.mdx#coordinate) | Northeast corner of the bounds |
| `southwest` | [`Coordinate`](../types.mdx#coordinate) | Southwest corner of the bounds |
